...
public class PersonDaoImpl extends HibernateTemplate implements PersonDao{
	...
	//pageSize代表一页显示的条数   page 代表当前页
	 public PageBean getPageBean(int pageSize, int page,String name){
		 
	        PageBean pageBean = new PageBean();
	        
	        //String hql = "from Person";
	        String hql = "from Person where 1=1 and name like '%"+name+"%'";
	...
	@Override
	public List<Person> fuzzy(String name) {
		List<Person> list=super.find("from Person where 1=1 and name like '%"+name+"%'");	
